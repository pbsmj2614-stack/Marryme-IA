      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3 mb-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {entrevista && ultimo && <RefazerRoteiroButton entrevistaId={entrevista.id} />}
            {entrevista && !ultimo && <GerarRoteiroButton entrevistaId={entrevista.id} />}
          </div>
        </div>
        ...
        {tab !== "campanha" && (
          <div className="space-y-4">
            ...
            >
              {ultimo?.analise_estrategica ? (
                ...
                <p className="text-sm text-gray-400">
                  Cadastre a entrevista para gerar esta seção.
                </p>
              )}
            </RoteiroCard>
            ...
            >
              {ultimo?.roteiro_sugerido?.roteiro ? (
                <div className="space-y-0">
                  {(ultimo.roteiro_sugerido.roteiro as CenaRoteiro[]).map(
                    (cena: CenaRoteiro, idx: number) => (
                      <div key={cena.cena}>
                        <div className="border-l-4 border-brand-300 pl-4 py-1">
                          ...
                          {cena.legenda_sugerida && (
                            <div className="bg-gray-50 rounded-md px-3 py-2 mt-2">
                              ...
                              <p className="text-xs text-gray-700 font-lora leading-[1.7] italic">
                                {cena.legenda_sugerida}
                              </p>
                            </div>
                          )}
                          {cena.orientacao_captacao && (
                            <div className="mt-2">
                              <p className="text-xs font-medium text-gray-400 mb-0.5">
                                Orientação de captação
                              </p>
                              <p className="text-xs text-gray-500 font-lora leading-[1.7]">
                                {cena.orientacao_captacao}
                              </p>
                            </div>
                          )}
                        ...
                        {idx <
                          ((ultimo.roteiro_sugerido?.roteiro as CenaRoteiro[])?.length ?? 0) -
                            1 && <hr className="my-5 border-gray-100" />}
                      </div>
                    )
                  )}
                </div>
            ...
            >
              {ultimo?.direcao_criativa?.direcao ? (
                <div className="space-y-4">
                  {(ultimo.direcao_criativa.direcao as DirecaoCena[]).map(
                    (d: DirecaoCena, i: number) => (
                      <div key={i} className="border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="grid sm:grid-cols-2 gap-3 text-sm">
                          ...
                          <div>
                            ...
                            <p className="font-lora leading-[1.7] text-gray-700 italic">
                              {d.legenda_sugerida}
                            </p>
                          </div>
                        </div>
